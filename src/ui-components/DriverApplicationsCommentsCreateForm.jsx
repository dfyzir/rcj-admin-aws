...
export default function DriverApplicationsCommentsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDriverApplicationsComments.replaceAll(
              "__typename",
              ""
            ),
            variables: {
      ...
      {...getOverrideProps(overrides, "DriverApplicationsCommentsCreateForm")}
      {...rest}
    >
      <TextField
        label="Text"
