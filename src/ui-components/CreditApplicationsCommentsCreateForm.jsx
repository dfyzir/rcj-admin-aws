...
export default function CreditApplicationsCommentsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCreditApplicationsComments.replaceAll(
              "__typename",
              ""
            ),
            variables: {
      ...
      {...getOverrideProps(overrides, "CreditApplicationsCommentsCreateForm")}
      {...rest}
    >
      <TextField
        label="Text"
